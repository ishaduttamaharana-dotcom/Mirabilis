...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Mirabilis — Visual Production Studio, Nagpur" },
      {
        name: "description",
        content:
          "Mirabilis is a Nagpur visual production studio: photography, videography, cinematography, brand films and 360° tours.",
      },
      { name: "author", content: "Mirabilis" },
      { property: "og:title", content: "Mirabilis — Visual Production Studio, Nagpur" },
      {
        property: "og:description",
        content:
          "Design · Build · Film. Golden-hour and after-dark storytelling for spaces and brands.",
      },
